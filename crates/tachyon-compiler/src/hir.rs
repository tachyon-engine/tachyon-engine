...
pub use expression::{
    ...
    HirExpression, HirExpressionKind, HirLogicalOperator, HirObjectExpressionPart,
    HirObjectProperty, HirObjectPropertyKey, HirObjectPropertyValue, HirUnaryOperator,
    HirUpdateOperator,
};
