...
pub use hir::{
    ...
    HirBinding, HirCatchClause, HirClass, HirExpression, HirExpressionKind, HirForInitializer,
    HirFunction, HirFunctionDeclaration, HirFunctionKind, HirIdentifierReference,
    HirLogicalOperator, HirObjectProperty, HirObjectPropertyKey, HirObjectPropertyValue,
    HirPattern, HirPatternKind, HirPatternProperty, HirProgram, HirScope, HirScopeFlags,
