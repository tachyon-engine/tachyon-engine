...
fn write_instruction(output: &mut String, opcode: Opcode, operands: &[u32; 3]) -> fmt::Result {
    ...
    match opcode {
        ...
        Opcode::LoadIteratorSymbol | Opcode::CheckObject => write!(output, " r{}", operands[0])?,
        Opcode::Move
        | Opcode::Not
        | Opcode::Negate
        | Opcode::Typeof
        ...
        Opcode::SetFunctionName => write!(output, " r{}, name={}", operands[0], operands[1])?,
        Opcode::Add
        | Opcode::Sub
        | Opcode::Mul
        | Opcode::Div
        ...
        Opcode::CallWithReceiver | Opcode::TailCallWithReceiver => write!(
            output,
            " r{}, receiver=r{}, argc={}",
            operands[0], operands[1], operands[2]
        )?,
